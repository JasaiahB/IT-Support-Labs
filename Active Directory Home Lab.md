...
- **Add a DHCP server**. Go to Add roles and features, DHCP server and install. After the installation configure set a New Scope by right clicking on the IPv4 server under DHCP. Make the start IP 10.10.10.100 and the end IP 10.10.10.200.
...
- **Create Windows 11 Pro VM**. Make sure to enable two adpaters on this vm, One adapter will be internal and the other NAT. This VM will act as our client PC connecting to the domain over a LAN connection.
